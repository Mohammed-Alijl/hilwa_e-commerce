...
@section('title',__('Front-end/pages/stores.edit.store'))
@section('css')
...
@section('page-header')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3>
                <strong>{{__('Front-end/pages/stores.title')}}</strong> / {{__('Front-end/pages/stores.edit.store')}}
            </h3>
        </div>
    </div>
@endsection
@section('content')
    ...
    @endif
    <form action="{{route('stores.update',$store->id)}}" method="post" id="create_user"
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('Front-end/pages/stores.edit.store')}}</h5>
                    <h6 class="card-subtitle text-muted">{{__('Front-end/pages/stores.edit.description')}}</h6>
                </div>
                <div class="card-body">

                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="language">{{__('Front-end/pages/stores.language')}}</label>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                   placeholder="{{__('Front-end/pages/stores.email')}}" required value="{{$store->email}}">
                            <div class="valid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="mobile_number"
                                       ...
                                       required maxlength="8" pattern=".{8,8}" value="{{$store->mobile_number}}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input required type="text" id="open_time" class="form-control open-time" placeholder="{{__('Front-end/pages/stores.open_time')}}"  name="open_time" value="{{$store->open_time}}"/>
                            <div class="valid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control close-time" id="close_time" placeholder="{{__('Front-end/pages/timeslots.select.time')}}" required name="close_time" value="{{$store->close_time}}"/>
                            <div class="valid-feedback">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select id="inputState" class="form-control choices-single" required>
                                @foreach($states as $state)
                                    <option value="{{$state->id}}" {{$state->id == $store->city->state->id ? 'selected' : ''}}>{{__('Front-end/states.' . $state->name)}}</option>
                                @endforeach
                            </select>
                            <div class="valid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6"  >
                            ...
                            <input type="text" class="form-control" id="longitude" name="longitude"
                                   placeholder="{{__('Front-end/pages/customers.longitude')}}" autocomplete="off" required value="{{$store->longitude}}"
                                   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            >
                            <div class="valid-feedback">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="postal_code" value="{{$store->zip_code}}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="status" id="status" class="form-control choices-single" required>
                                <option value="1" {{$store->status ? 'selected' : ''}}>{{__('Front-end/pages/stores.enable')}}</option>
                                <option value="0" {{!$store->status ? 'selected' : ''}}>{{__('Front-end/pages/stores.disable')}}</option>
                            </select>
                            <div class="valid-feedback">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function updateCityOptions(StateId) {
                if (StateId) {
                    $.ajax({
                        url: "{{ URL::to('admin/state-cities') }}/" + StateId,
                        type: "GET",
                        dataType: "json",
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#language").change(function() {
                ...
                $.ajax({
                    url: "{{ URL::to('admin/store-languages') }}/" + languageId + '/' + {{$store->id}},
                    method: "GET",
                    success: function(data) {
                        $("#name").val(data.store_name);
                    },
