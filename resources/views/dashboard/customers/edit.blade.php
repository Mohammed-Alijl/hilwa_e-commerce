...
@section('title',__('Front-end/pages/customers.edit.customer'))
@section('css')
...
@section('content')
    ...
    @endif
    <form action="{{route('customers.update',$customer->id)}}" method="post" enctype="multipart/form-data" id="create_user"
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('Front-end/pages/customers.edit.customer')}}</h5>
                    <h6 class="card-subtitle text-muted">{{__('Front-end/pages/customers.edit.description')}}</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            <label class="form-label"
                                   for="name">{{__('Front-end/pages/customers.name')}}</label>
                            <input type="text" class="form-control" id="name" name="name"
                                   placeholder="{{__('Front-end/pages/customers.name')}}" autocomplete="off" required value="{{$customer->name}}">
                            <div class="valid-feedback">
                                {{__('Front-end/pages/customers.name.valid')}}
                            </div>
                            <div class="invalid-feedback">
                                {{__('Front-end/pages/customers.name.invalid')}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                   placeholder="{{__('Front-end/pages/users.email')}}" required value="{{$customer->email}}">
                            <div class="valid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="mobile_number" value="{{$customer->mobile_number}}"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control" id="latitude" name="latitude[]"
                                   placeholder="{{__('Front-end/pages/customers.latitude')}}" autocomplete="off" required value="{{$address->latitude}}"
                                   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            >
                        ...
                        <div class="mb-3 col-md-4"  >
                            ...
                            <input type="text" class="form-control" id="longitude" name="longitude[]"
                                   placeholder="{{__('Front-end/pages/customers.longitude')}}" autocomplete="off" required value="{{$address->longitude}}"
                                   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            >
                            <div class="valid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="address_two" name="address_two[]" value="{{$address->address_two}}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <button type="button" onclick="deletes({{ $address->id }})" class="btn btn-danger">{{__('Front-end/pages/customers.delete')}}</button>
                        </div>
                    </div>
                    @endif
                </div>
