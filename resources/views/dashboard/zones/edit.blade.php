...
@section('title',__('Front-end/pages/zones.edit.zone'))
@section('css')
...
@section('page-header')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>{{__('Front-end/pages/zones.title')}}</strong> / {{__('Front-end/pages/zones.edit.zone')}}</h3>
        </div>
    </div>
@endsection
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">{{__('Front-end/pages/zones.edit.zone')}}</h5>
                <h6 class="card-subtitle text-muted">{{__('Front-end/pages/zones.edit.description')}}</h6>
            </div>
            <div class="card-body">
                <form action="{{route('zones.update',$zone->id)}}" method="post" id="create_user"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   placeholder="{{__('Front-end/pages/zones.name')}}" autocomplete="off" required value="{{$zone->name}}">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select id="inputState" class="form-control choices-single" required>
                                <option selected value="{{$zone->city->state_id}}">{{$zone->city->state->name}}</option>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select id="inputCity" name="city_id" class="form-control choices-single" required>
                                <option selected value="{{$zone->city->id}}">{{$zone->city->name}}</option>
                            </select>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="status" id="status" class="form-control choices-single" required>
                                <option value="1" {{$zone->status ? 'selected': ''}}>{{__('Front-end/pages/zones.enable')}}</option>
                                <option value="0" {{$zone->status ? '' : 'selected'}}>{{__('Front-end/pages/zones.disable')}}</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" id="tags-input" data-role="tagsinput" name="postal_codes" class="bootstrap-tagsinput" value="{{$postal_codes}}">
                            <div class="valid-feedback">
